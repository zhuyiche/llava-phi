"""This file is copied from https://github.com/MMMU-Benchmark/MMMU/blob/main/eval/main_eval_only.py"""

import json
from argparse import ArgumentParser

from mipha.eval.mmmu_data_utils import CAT_SHORT2LONG, DOMAIN_CAT2SUB_CAT
from mipha.eval.mmmu_eval_utils import evaluate, parse_open_response, calculate_ins_level_acc
