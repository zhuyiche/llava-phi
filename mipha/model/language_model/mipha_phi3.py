...
class MiphaPhi3Model(MiphaMetaModel, Phi3Model):
...
class MiphaPhi3ForCausalLM(Phi3PreTrainedModel, MiphaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.model = MiphaPhi3Model(config)
...
AutoConfig.register("mipha_phi3", MiphaPhi3Config)
AutoModelForCausalLM.register(MiphaPhi3Config, MiphaPhi3ForCausalLM)
